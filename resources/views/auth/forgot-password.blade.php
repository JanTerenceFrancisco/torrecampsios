...
<head>
    ...
    <meta charset="utf-8" />
    <title>Recover Password TMIOS Admin</title>
                    ...
                    <div class="text-center mt-4">
                        <div class="mb-3">
                            <a href="{{ route('login') }}" class="auth-logo">
                                <img src="{{ asset('logo/logo.png') }}" height="70" class="logo-dark mx-auto"
                                    alt="">
                                <img src="{{ asset('logo/logo.png') }}" height="70" class="logo-light mx-auto"
                                    alt="">
                            </a>
                        </div>
                    </div>
