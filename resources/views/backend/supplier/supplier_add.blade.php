                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('supplier.store') }}" id="myForm">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input class="form-control" name="supplier_phone" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input class="form-control" name="supplier_email" type="email">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input class="form-control" name="supplier_address" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
